                            ...
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <blockquote>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p><small> - Someone famous in <cite title="Source Title">Source
                                                    Title</cite></small>
                                        </blockquote>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <ul class="list-icons">
                                            <li><a href="javascript:void(0)"><span class="align-middle"><i class="fa fa-check text-info"></i></span>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <ul class="list-icons">
                                            <li><a href="javascript:void(0)"><span class="align-middle"><i class="fa fa-chevron-right"></i></span> Lorem
                                                    ipsum dolor sit amet</a>
                                            </li>
                                            <li><a href="javascript:void(0)"><span class="align-middle"><i class="fa fa-chevron-right"></i></span>
                                                    Consectetur adipiscing elit</a>
                                            </li>
                                            <li><a href="javascript:void(0)"><span class="align-middle"><i class="fa fa-chevron-right"></i></span>
                                                    Integer molestie lorem at massa</a>
