                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3 img-fluid" src="images/avatar/1.jpg" alt="DexignLab">
                                        <div class="media-body">
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 img-fluid" src="images/avatar/7.jpg" alt="DexignLab">
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3" src="images/avatar/2.jpg" alt="DexignLab">
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                            ...
                                            <div class="media mt-3">
                                                <a class="pr-3" href="#">
                                                    <img src="images/avatar/3.jpg" alt="DexignLab">
                                                </a>
                                                <div class="media-body">
                                                    <h5 class="mt-0">Media heading</h5>
                                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-start mr-3" src="images/avatar/4.jpg" alt="DexignLab">
                                        <div class="media-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-center mr-3" src="images/avatar/5.jpg" alt="DexignLab">
                                        <div class="media-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-end mr-3" src="images/avatar/6.jpg" alt="DexignLab">
                                        <div class="media-body">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        ...
                                        <img class="ml-3" src="images/avatar/7.jpg" alt="DexignLab">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <ul class="list-unstyled">
                                        <li class="media">
                                            <img class="mr-3" src="images/avatar/8.jpg" alt="DexignLab">
                                            <div class="media-body">
                                        ...
                                        <li class="media my-4">
                                            <img class="mr-3" src="images/avatar/1.jpg" alt="DexignLab">
                                            <div class="media-body">
                                                <h5 class="mt-0 mb-1">List-based media object</h5>
                                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                                vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
