	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#6673fd', 'rgb(255, 184, 0)', '#2bc155'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#f35757', '#2bc155', '#6673fd'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(243, 87, 87)', 'rgb(0, 171, 197)', '#6673fd'],
				resize: true
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#6673fd', 'rgb(16, 202, 147)', 'rgb(255, 184, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
