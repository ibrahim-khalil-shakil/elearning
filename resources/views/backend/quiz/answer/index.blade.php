                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$q->id}}</td>
                                                <td>{{$q->title}}</td>
                                                <td>{{$q->student?->name_en}}</td>
                                                <td>
                                                    <a href="{{route('answer.edit', encryptor('encrypt',$q->id))}}"
                                                    ...
                                                    <form id="form{{$q->id}}"
                                                        action="{{route('answer.destroy', encryptor('encrypt',$q->id))}}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="4" class="text-center">No Answer Found</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
