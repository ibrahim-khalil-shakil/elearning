                    ...
                    <div class="browse-categories-item-icon">
                        <div class="categories-two default-categories">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                ...
                                <path d="M20 28.3334V35" stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                ...
                <div class="browse-categories-item default-item-three">
                    <div class="browse-categories-item-icon">
                        <div class="categories-three default-categories">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 31.6667L31.6667 20L36.6667 25L25 36.6667L20 31.6667Z" stroke="currentColor"
                                    stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    d="M29.9999 21.6667L27.4999 9.16671L3.33325 3.33337L9.16659 27.5L21.6666 30L29.9999 21.6667Z"
                                    stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M3.33325 3.33337L15.9766 15.9767" stroke="currentColor" stroke-width="3"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path
                        ...
                        <div class="categories-five default-categories">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M5.44995 11.6L20 20.0166L34.5499 11.6" stroke="currentColor" stroke-width="3"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M20 36.8V20" stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#">
                                        <img src="{{asset('public/frontend/dist/images/courses/demo-img-02.png')}}"
...
<section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
    <div class="container">
            ...
            <div class="col-12 position-relative px-0 mx-0">
                <div class="eventsSlider">
                    <div class="contentCard contentCard--event contentCard--space">
                        <div class="contentCard-top">
                            <a href="#"><img
                                    src="{{asset('public/frontend/dist/images/courses/demo-img-01.png')}}" alt="images"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
                    ...
                    <div class="contentCard contentCard--event contentCard--space">
                        <div class="contentCard-top">
                            <a href="#"><img
                                    src="{{asset('public/frontend/dist/images/courses/demo-img-02.png')}}" alt="images"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
                    ...
                    <div class="contentCard contentCard--event contentCard--space">
                        <div class="contentCard-top">
                            <a href="#"><img
                                    src="{{asset('public/frontend/dist/images/courses/demo-img-03.png')}}" alt="images"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
                    ...
                    <div class="contentCard contentCard--event contentCard--space">
                        <div class="contentCard-top">
                            <a href="#"><img
                                    src="{{asset('public/frontend/dist/images/courses/demo-img-04.png')}}" alt="images"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="event-search.html" class="button button-lg button--primary mt-lg-5 mt-5">Browse all
                    events</a>
            </div>
        </div>
    </div>
