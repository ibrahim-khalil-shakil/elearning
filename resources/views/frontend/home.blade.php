                    ...
                    <div class="browse-categories-item default-item-one mb-2">
                        <div class="browse-categories-item-icon">
                            <div class="categories-one default-categories">
                               <img src="{{asset('public/uploads/courseCategories/'.$cat->category_image)}}" class="rounded-circle" width="80" height="80" alt="">
                            </div>
                        </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="contentCard contentCard--course">
                                    ...
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a href="#" class="font-title--card">{{$pc->title_en}}</a>
                                        </h5>
                                        <div class="contentCard-info d-flex align-items-center justify-content-between">
                                            <a href="instructor-profile.html" class="contentCard-user d-flex align-items-center">
                                                <img src="{{asset('public/uploads/instructors/'.$pc?->instructor->image)}}" alt="client-image"
                        ...
                        <div class="contentCard contentCard--event contentCard--space">
                            ...
                            <div class="contentCard-bottom">
                                ...
                                <div class="contentCard-more">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="icon">
                                            <img src="{{asset('public/frontend/dist/images/icon/calendar.png')}}" alt="calendar" />
                                        </div>
